...
(10, '2024-04-28 09:45:25', 'hello world', 3);

CREATE MEMORY TABLE "PUBLIC"."REPORTE"(
    "ID" BIGINT NOT NULL, -- auto increment
    "COMENTARIO" CHARACTER VARYING(255), -- default null or delete this part
    --"COMENTARIO_REPORTE" CHARACTER VARYING(255), --get it from formulario
    "ESTADO" INTEGER, --default pendiente
    --"PRIORIDAD" INTEGER, --NOT NULL, choose by funcionario or delete
    "TIPO" CHARACTER VARYING(255),--INTEGER, --get it from formulario
    "FUENTE_ID" BIGINT, --get it from path
    "AUTHOR_ID" BIGINT, --get it from "session"
...
-- ALTER TABLE "PUBLIC"."REPORTE" ADD CONSTRAINT "PUBLIC"."FKFGOF8KTQAUQQ5C4E8XHC98XAE" FOREIGN KEY("AUTHOR_ID") REFERENCES "PUBLIC"."USUARIO"("ID") NOCHECK;   
...
ALTER TABLE "PUBLIC"."REPORTE" ADD CONSTRAINT "PUBLIC"."NAMEOFHTECONSTRAINT" FOREIGN KEY ("FUNC_ID") REFERENCES "PUBLIC"."IWUSER"("ID") NOCHECK;
ALTER TABLE "PUBLIC"."VALORACION" ADD CONSTRAINT "FK_VALORACION_FUENTE" 
FOREIGN KEY("FUENTE_ID") REFERENCES "PUBLIC"."FUENTE"("ID") ON DELETE CASCADE;
ALTER TABLE "PUBLIC"."REPORTE" ADD CONSTRAINT "FK_REPORTE_FUENTE" 
FOREIGN KEY("FUENTE_ID") REFERENCES "PUBLIC"."FUENTE"("ID") ON DELETE CASCADE;